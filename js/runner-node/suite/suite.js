...
_trampoline15.fnName = 'wasi:cli/exit@0.2.6#exit';
...
_trampoline16.fnName = 'wasi:io/poll@0.2.6#block';
...
_trampoline17.fnName = 'wasi:io/streams@0.2.6#subscribe';
...
_trampoline18.fnName = 'wasi:cli/stdin@0.2.6#getStdin';
...
_trampoline19.fnName = 'wasi:cli/stdout@0.2.6#getStdout';
...
_trampoline20.fnName = 'wasi:cli/stderr@0.2.6#getStderr';
...
_trampoline21.fnName = 'wasi:clocks/monotonic-clock@0.2.6#now';
let exports1;
let memory0;
let realloc0;
let realloc0Async;
...
const _trampoline25 = async function(arg0, arg1, arg2) {
  var handle1 = arg0;
  ...
  _debugLog('[iface="polymorph:test/test-context@0.1.0", function="[method]context.diagnostic"] [Instruction::CallInterface] (async, @ enter)');
  const hostProvided = true;
  ...
  curResourceBorrows = [];
  _debugLog('[iface="polymorph:test/test-context@0.1.0", function="[method]context.diagnostic"][Instruction::AsyncTaskReturn]', {
    funcName: '[task-return][method]context.diagnostic',
    paramCount: 0,
    componentIdx: 0,
    postReturn: false,
    hostProvided,
  ...
  queueMicrotask(async (resolve, reject) => {
    try {
      _debugLog("[Instruction::AsyncTaskReturn] starting driver loop", {
        fnName: '[task-return][method]context.diagnostic',
...
_trampoline25.fnName = 'polymorph:test/test-context@0.1.0#diagnostic';
...
_trampoline26.fnName = 'wasi:io/streams@0.2.6#checkWrite';
...
_trampoline27.fnName = 'wasi:io/streams@0.2.6#write';
...
_trampoline28.fnName = 'wasi:io/streams@0.2.6#blockingFlush';
...
_trampoline29.fnName = 'wasi:cli/environment@0.2.6#getEnvironment';
...
_trampoline30.fnName = 'wasi:cli/terminal-stdin@0.2.6#getTerminalStdin';
...
_trampoline31.fnName = 'wasi:cli/terminal-stdout@0.2.6#getTerminalStdout';
...
_trampoline32.fnName = 'wasi:cli/terminal-stderr@0.2.6#getTerminalStderr';
...
_trampoline33.fnName = 'wasi:clocks/wall-clock@0.2.6#now$1';
let exports2;
let postReturn0;
...
let tests010MethodTestCaseName;

class TestCase{
  constructor () {
    throw new Error('"TestCase" resource does not define a constructor');
  }
}
...
TestCase.prototype.name = function name() {
  ...
  if (!handle1 || (handleTable7[(handle1 << 1) + 1] & T_FLAG) === 0) {
    throw new TypeError('Resource error: Not a valid \"TestCase\" resource.');
  }
  var handle0 = handleTable7[(handle1 << 1) + 1] & ~T_FLAG;
  
  _debugLog('[iface="polymorph:test/tests@0.1.0", function="[method]test-case.name"][Instruction::CallWasm] enter', {
    funcName: '[method]test-case.name',
    paramCount: 1,
    async: false,
    postReturn: true,
  });
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    entryFnName: 'tests010MethodTestCaseName',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'none',
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => tests010MethodTestCaseName(handle0),
    });
  } catch (err) {
  ...
  _debugLog('[iface="polymorph:test/tests@0.1.0", function="[method]test-case.name"][Instruction::Return]', {
    funcName: '[method]test-case.name',
    paramCount: 1,
    async: false,
    postReturn: true
...
let tests010MethodTestCaseRun;

TestCase.prototype.run = async function run(arg1) {
  ...
  if (!handle2) {
    const rep = arg1[symbolRscRep] || ++captureCnt0;
    captureTable0.set(rep, arg1);
    handle2 = rscTableCreateBorrow(handleTable0, rep, SCOPE_ID);
  }
  
  _debugLog('[iface="polymorph:test/tests@0.1.0", function="[method]test-case.run"][Instruction::CallWasm] enter', {
    funcName: '[method]test-case.run',
    paramCount: 2,
    async: true,
    postReturn: false,
  });
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isManualAsync: false,
    preserveFutureResult: false,
    entryFnName: 'tests010MethodTestCaseRun',
  ...
  try {
    ret =  await  _withGlobalCurrentTaskMetaAsync({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => tests010MethodTestCaseRun(handle0, handle2),
    });
  } catch (err) {
  ...
  _debugLog('[iface="polymorph:test/tests@0.1.0", function="[method]test-case.run"][Instruction::AsyncTaskReturn]', {
    funcName: '[method]test-case.run',
    paramCount: 1,
    componentIdx: 0,
    postReturn: false,
...
async function all() {
  _debugLog('[iface="polymorph:test/tests@0.1.0", function="all"][Instruction::CallWasm] enter', {
    funcName: 'all',
    paramCount: 0,
    async: true,
    postReturn: false,
  ...
  _debugLog('[iface="polymorph:test/tests@0.1.0", function="all"][Instruction::AsyncTaskReturn]', {
    funcName: 'all',
    paramCount: 1,
    componentIdx: 0,
    postReturn: false,
...
const trampoline5 = waitableJoin.bind(null, 0);

const trampoline6 = waitableSetDrop.bind(null, 0);

const trampoline7 = taskCancel.bind(null, 0);

const trampoline8 = subtaskDrop.bind(
null,
0,
);
...
null,
{
  ...
  liftFns: [_liftFlatList({
    elemLiftFn: _liftFlatOwn({
      ...
      createResourceFn: 
      (handle) => {
        const resourceObj = Object.create(TestCase.prototype);
        Object.defineProperty(resourceObj, symbolRscHandle, {
          writable: true,
          value: handle,
        });
        finalizationRegistry7.register(resourceObj, handle, resourceObj);
  ...
  lowerFns: [_lowerFlatList({
    elemLowerFn: _lowerFlatOwn({
      componentIdx: 0,
      lowerFn: 
      function lowerExportedOwnedHost_TestCase(obj) {
        let handle = obj[symbolRscHandle];
        if (!handle) {
          throw new TypeError('Resource error: Not a valid \"TestCase\" resource.');
        }
        finalizationRegistry7.unregister(obj);
...
null,
{
  ...
  _liftFlatResult({
    caseMetas: [['ok', null, 0, 0, 0],['err', _liftFlatVariant({
      caseMetas: [['failed', _liftFlatStringAny, 8, 4, 2],['skipped', _liftFlatStringAny, 8, 4, 2],],
      variantSize32: 12,
      variantAlign32: 4,
  ...
  _lowerFlatResult({
    ...
    [ 'err', _lowerFlatVariant({
      caseMetas: [[ 'failed', _lowerFlatStringAny, 8, 4, 2 ],[ 'skipped', _lowerFlatStringAny, 8, 4, 2 ],],
      variantSize32: 12,
      variantAlign32: 4,
      variantPayloadOffset32: 4,
      variantFlatCount: 3,
...
let trampoline25 = new WebAssembly.Suspending(_lowerImport.bind(
null,
{
  trampolineIdx: 25,
  componentIdx: 0,
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./suite.core.wasm', import.meta.url));
    const module1 = base64Compile('');
    const module2 = base64Compile('');
    ...
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      $root: {
        ...
        '[subtask-drop]': trampoline8,
        '[waitable-join]': trampoline5,
        '[waitable-set-drop]': trampoline6,
        '[waitable-set-new]': trampoline4,
        '[waitable-set-poll]': exports0['0'],
      },
      '[export]$root': {
        '[task-cancel]': trampoline7,
      },
      '[export]polymorph:test/tests@0.1.0': {
        '[resource-drop]test-case': trampoline2,
        '[resource-new]test-case': trampoline1,
        '[task-return][method]test-case.run': exports0['2'],
        '[task-return]all': exports0['1'],
      },
      'polymorph:test/test-context@0.1.0': {
        '[async-lower][method]context.diagnostic': exports0['3'],
        '[resource-drop]context': trampoline3,
      },
      ...
      'wasi:io/poll@0.2.0': {
        '[method]pollable.block': trampoline16,
    ...
    ({ exports: exports2 } = yield instantiateCore(yield module2, {
      '': {
        ...
        '10': trampoline32,
        '11': trampoline33,
        '12': exports1['polymorph:test/tests@0.1.0#[dtor]test-case'],
        '2': trampoline24,
        '3': trampoline25,
        '4': trampoline26,
        '5': trampoline27,
    ...
    postReturn0 = exports1['cabi_post_polymorph:test/tests@0.1.0#[method]test-case.name'];
    
    try {
      postReturn0Async = WebAssembly.promising(exports1['cabi_post_polymorph:test/tests@0.1.0#[method]test-case.name']);
    } catch(err) {
      postReturn0Async = exports1['cabi_post_polymorph:test/tests@0.1.0#[method]test-case.name'];
    }
    
    
    callback_0 = WebAssembly.promising(exports1['[callback][async-lift]polymorph:test/tests@0.1.0#[method]test-case.run']);
    callback_0.fnName = "exports1['[callback][async-lift]polymorph:test/tests@0.1.0#[method]test-case.run']";
    
    
    callback_1 = WebAssembly.promising(exports1['[callback][async-lift]polymorph:test/tests@0.1.0#all']);
    callback_1.fnName = "exports1['[callback][async-lift]polymorph:test/tests@0.1.0#all']";
    
    tests010MethodTestCaseName = exports1['polymorph:test/tests@0.1.0#[method]test-case.name'];
    tests010MethodTestCaseRun = WebAssembly.promising(exports1['[async-lift]polymorph:test/tests@0.1.0#[method]test-case.run']);
    tests010All = WebAssembly.promising(exports1['[async-lift]polymorph:test/tests@0.1.0#all']);
  })();
...
export { tests010 as tests, tests010 as 'polymorph:test/tests@0.1.0',  }
export const _util = {
