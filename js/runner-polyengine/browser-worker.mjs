// The polyengine browser-side shard worker — the runtime-linked sibling of
...
//
//   {
//     bundleUrl,      // polyengine-embedder.mjs, built from the pinned JSR
//                     // graph by `just polyengine-assets`
//     translatorUrl,  // polyengine-translator-shim.wasm, extracted from the
//                     // same locked graph (@polyengine/translator's asset)
